...
{{-- index catygories --}}
                ...
                <div class="card" dir="rtl">
                    ...
                    <div class="card-header w-full">
                        <h3 class="card-title inline text-center w-full bg-warning text-white px-5 rounded-2">بيانات القسم الرئيسي</h3>
                        <div>
                        ...
                        <div>
                            ...
                            <x-jet-label class="inline" value="{{ $category->is_deleted ? "محذوف" : "نشط" }}" />
                        </div>
                        <div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $subcategory->is_deleted ? "محذوف" : "نشط" }}</td>
