                    ...
                    <div class="flex-1 bg-white rounded-lg shadow-lg overflow-hidden border-b border-gray-200">
                        <div style="height:350px;">
                                <span 
                                    ...
                                    class=" {{ $product->cart->first->product_id ? 'text-red-500' : 'text-white' }} position-absolute mx-4 mr-2 mt-2 cursor-pointer material-symbols-outlined user-select-none "
